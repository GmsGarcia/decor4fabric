...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.dark_oak_logSmallStool_BlockEntity;
...
public class dark_oak_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new dark_oak_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof dark_oak_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (dark_oak_logSmallStool_BlockEntity)blockEntity);
