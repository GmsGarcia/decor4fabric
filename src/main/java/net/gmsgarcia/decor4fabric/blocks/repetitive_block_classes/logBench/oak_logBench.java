...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench.oak_logBench_BlockEntity;
...
public class oak_logBench extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new oak_logBench_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof oak_logBench_BlockEntity) {
                ItemScatterer.spawn(world, pos, (oak_logBench_BlockEntity)blockEntity);
