...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.jungle_logSmallStool_BlockEntity;
...
public class jungle_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new jungle_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof jungle_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (jungle_logSmallStool_BlockEntity)blockEntity);
