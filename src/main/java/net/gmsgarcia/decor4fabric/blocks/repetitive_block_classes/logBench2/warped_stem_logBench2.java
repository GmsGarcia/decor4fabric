...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench2.warped_stem_logBench2_BlockEntity;
...
public class warped_stem_logBench2 extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new warped_stem_logBench2_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof warped_stem_logBench2_BlockEntity) {
                ItemScatterer.spawn(world, pos, (warped_stem_logBench2_BlockEntity)blockEntity);
