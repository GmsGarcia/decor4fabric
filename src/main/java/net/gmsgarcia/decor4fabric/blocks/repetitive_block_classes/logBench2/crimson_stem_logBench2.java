...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench2.crimson_stem_logBench2_BlockEntity;
...
public class crimson_stem_logBench2 extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new crimson_stem_logBench2_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof crimson_stem_logBench2_BlockEntity) {
                ItemScatterer.spawn(world, pos, (crimson_stem_logBench2_BlockEntity)blockEntity);
