...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench2.dark_oak_logBench2_BlockEntity;
...
public class dark_oak_logBench2 extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new dark_oak_logBench2_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof dark_oak_logBench2_BlockEntity) {
                ItemScatterer.spawn(world, pos, (dark_oak_logBench2_BlockEntity)blockEntity);
