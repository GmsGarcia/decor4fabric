...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.birch_logSmallStool_BlockEntity;
...
public class birch_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new birch_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof birch_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (birch_logSmallStool_BlockEntity)blockEntity);
