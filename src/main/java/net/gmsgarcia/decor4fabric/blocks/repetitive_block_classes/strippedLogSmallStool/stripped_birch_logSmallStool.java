...
import net.gmsgarcia.decor4fabric.blocks.block_entities.strippedLogSmallStool.stripped_birch_logSmallStool_BlockEntity;
...
public class stripped_birch_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public stripped_birch_logSmallStool() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new stripped_birch_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof stripped_birch_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (stripped_birch_logSmallStool_BlockEntity)blockEntity);
