...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench.acacia_logBench_BlockEntity;
...
public class acacia_logBench extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final IntProperty AXE_TYPE = IntProperty.of("axe_type", 0,6);

    public acacia_logBench() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new acacia_logBench_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof acacia_logBench_BlockEntity) {
                ItemScatterer.spawn(world, pos, (acacia_logBench_BlockEntity)blockEntity);
