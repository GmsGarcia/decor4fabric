package net.gmsgarcia.decor4fabric.blocks.repetitive_block_classes.logSmallStool;

import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.crimson_stem_logSmallStool_BlockEntity;
...
public class crimson_stem_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public crimson_stem_logSmallStool() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new crimson_stem_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof crimson_stem_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (crimson_stem_logSmallStool_BlockEntity)blockEntity);
