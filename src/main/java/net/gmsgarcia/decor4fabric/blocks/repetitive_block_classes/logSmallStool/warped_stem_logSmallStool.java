...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.warped_stem_logSmallStool_BlockEntity;
...
public class warped_stem_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public warped_stem_logSmallStool() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new warped_stem_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof warped_stem_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (warped_stem_logSmallStool_BlockEntity)blockEntity);
