...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench.crimson_stem_logBench_BlockEntity;
...
public class crimson_stem_logBench extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final IntProperty AXE_TYPE = IntProperty.of("axe_type", 0,6);

    public crimson_stem_logBench() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new crimson_stem_logBench_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof crimson_stem_logBench_BlockEntity) {
                ItemScatterer.spawn(world, pos, (crimson_stem_logBench_BlockEntity)blockEntity);
