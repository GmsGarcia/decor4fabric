...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logBench.warped_stem_logBench_BlockEntity;
...
public class warped_stem_logBench extends HorizontalFacingBlock implements BlockEntityProvider {

    public static final IntProperty AXE_TYPE = IntProperty.of("axe_type", 0,6);

    public warped_stem_logBench() {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new warped_stem_logBench_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof warped_stem_logBench_BlockEntity) {
                ItemScatterer.spawn(world, pos, (warped_stem_logBench_BlockEntity)blockEntity);
