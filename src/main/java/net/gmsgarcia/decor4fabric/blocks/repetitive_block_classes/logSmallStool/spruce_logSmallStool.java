...
import net.gmsgarcia.decor4fabric.blocks.block_entities.logSmallStool.spruce_logSmallStool_BlockEntity;
...
public class spruce_logSmallStool extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new spruce_logSmallStool_BlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof spruce_logSmallStool_BlockEntity) {
                ItemScatterer.spawn(world, pos, (spruce_logSmallStool_BlockEntity)blockEntity);
